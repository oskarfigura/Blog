...
namespace Blog.Utils
{
    ...
    {
        /**
         * Update html generated by wysiwyg editor to ensure that content
        ...
        public static string FormatPostContent(string content)
        {
            ...
            var startOfVideoTags =
                "<div class=\"embed-responsive embed-" +
                "responsive-16by9\"><iframe allowfullscreen=\"true\"";
            var endOfVideoTags = "></iframe></div>";
            result = result.Replace("<iframe ", startOfVideoTags)
                .Replace("></iframe>", endOfVideoTags);
